                    ...
                    {mealData.items.map((item) => (
                      <div key={item.id} className="flex justify-between items-center text-sm group">
                        ...
                        <div className="flex items-center gap-2">
                          <span className="font-bold">{Math.round(item.calories)} kcal</span>
                          <button
                            onClick={() => removeFood(item.id)}
                            className="w-6 h-6 rounded-full opacity-0 group-hover:opacity-100 bg-red-500/20 flex items-center justify-center hover:bg-red-500/40 transition-all"
                          >
