...
def api_log_food():
    ...
    quantity_g = food["serving_size_g"] * servings
    calories = round(food["calories_per_serving"] * servings, 1)
    protein = round(food["protein_per_serving"] * servings, 1)
    carbs = round(food["carbs_per_serving"] * servings, 1)
    fat = round(food["fat_per_serving"] * servings, 1)
